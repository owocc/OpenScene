...
const nimbusConfig = defineNimbusConfig({
  site: "https://docs.openscene.dev",
  title: "OpenScene",
  description: "Reference documentation for OpenScene runtimes and Studio integration.",
  locale: "en",
  github: null,
  socialImageAlt: "OpenScene documentation preview",
});
